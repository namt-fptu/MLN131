...
const topicsData: TopicDetail[] = [
  {
    ...
    description:
      "Nội dung cốt lõi của CNXHKH, làm sáng tỏ vai trò lãnh đạo cách mạng.",
    icon: "⚒",
  ...
  },
  {
    ...
    description:
      "Tính tất yếu, đặc điểm và các quy luật của quá trình chuyển biến.",
    icon: "⏳",
  ...
  },
  {
    ...
    description:
      "Quan điểm lịch sử, cụ thể trong giải quyết tín ngưỡng, tôn giáo.",
    icon: "☯",
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-gray-400 text-lg">
              Hệ thống lý luận cơ bản và chuyên sâu về Chủ nghĩa Xã hội Khoa
              học.
            </p>
          </div>
          ...
          <div className="relative w-full md:w-96 group">
            ...
            />
            <svg
              className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 w-4 h-4 group-focus-within:text-cnxh-red transition-colors"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
        ...
        <div className="flex flex-wrap gap-8 mb-12 pb-8 border-b border-white/5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white font-bold text-xl">
                {topicsData.reduce((acc, t) => acc + t.keyPoints.length, 0)}
              </p>
              <p className="text-gray-500 text-xs uppercase tracking-wider">
                Ý chính
              </p>
              ...
              onMouseEnter={(e) => {
                if (window.gsap)
                  window.gsap.to(e.currentTarget, {
                    y: -5,
                    boxShadow: "0 20px 40px -10px rgba(128,0,32,0.3)",
                  });
              }}
              onMouseLeave={(e) => {
                if (window.gsap)
                  window.gsap.to(e.currentTarget, { y: 0, boxShadow: "none" });
              }}
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-serif text-white mb-3 group-hover:text-cnxh-red transition-colors duration-300">
                  {topic.title}
                </h3>
                ...
                <div className="mt-6 pt-6 border-t border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-gray-500">
                      {topic.keyPoints.length} ý chính
                    </span>
                  </div>
        ...
        {filteredTopics.length === 0 && (
          <div className="text-center py-20">
            <p className="text-gray-500 text-lg">
              Không tìm thấy chủ đề phù hợp với "{searchQuery}"
            </p>
          </div>
        )}
      </div>
