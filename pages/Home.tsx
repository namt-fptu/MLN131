  ...
  const handleCardHover = (
    ...
    if (window.gsap) {
      window.gsap.to(e.currentTarget, {
        scale: enter ? 1.03 : 1,
        boxShadow: enter
          ? "0 10px 30px -10px rgba(128, 0, 32, 0.5)"
    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            filter:
              "grayscale(100%) sepia(20%) hue-rotate(320deg) saturate(150%)",
          }}
        ></div>
        ...
        >
          <p className="hero-line text-red-500 text-sm md:text-base font-bold tracking-[0.3em] uppercase mb-6 drop-shadow-md">
          ...
          <p className="hero-line text-gray-200 max-w-2xl mx-auto text-lg md:text-xl font-light leading-relaxed drop-shadow-md">
            Khám phá nền tảng lý luận, sứ mệnh lịch sử và giá trị thời đại của
            học thuyết Mác - Lênin trong thế kỷ 21.
          </p>
          <div className="hero-line mt-12">
            <button className="group relative px-8 py-3 bg-transparent border border-white/20 overflow-hidden rounded-sm transition-all hover:border-cnxh-red">
              ...
              <span className="relative text-sm tracking-widest uppercase font-medium group-hover:text-white">
                Bắt đầu học
              </span>
            </button>
          </div>
        ...
        <div ref={quoteRef} className="max-w-4xl px-6 text-center">
          <div className="text-4xl md:text-5xl lg:text-6xl font-serif text-cnxh-light leading-snug">
            ...
            {quoteText.split("").map((char, index) => (
              <span
                key={index}
                className="char opacity-0 inline-block"
                style={{ minWidth: char === " " ? "10px" : "0" }}
              >
                {char}
              </span>
            ))}
          ...
          <div
            className="mt-8 text-cnxh-red text-sm tracking-widest uppercase font-medium opacity-0 char"
      ...
      <section ref={featureRef} className="py-24 px-6 max-w-7xl mx-auto">
        <div className="flex items-end justify-between mb-16">
          ...
          <a
            href="/blog"
            className="text-sm text-gray-400 hover:text-cnxh-red transition-colors"
          >
            Xem tất cả &rarr;
          </a>
        </div>
            ...
            >
              <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="text-cnxh-red"
                >
                  <path d="M12 2L2 7l10 5 10-5-10-5zm0 9l2.5-1.25L12 8.5l-2.5 1.25L12 11zm0 2.5l-5-2.5-5 2.5L12 22l10-8.5-5-2.5-5 2.5z" />
                </svg>
              </div>
              <div className="text-cnxh-red text-xs font-bold tracking-widest mb-4">
                LÝ LUẬN
              </div>
              <h3 className="text-xl font-serif text-white mb-4 group-hover:text-cnxh-red transition-colors">
                {item === 1
                  ...
                  : item === 2
                  ? "Dân chủ xã hội chủ nghĩa trong thời đại mới"
                  : "Vấn đề dân tộc và tôn giáo ở Việt Nam"}
              </h3>
              <p className="text-sm text-gray-400 leading-relaxed mb-6">
                Phân tích sâu sắc về vai trò và vị trí của các yếu tố cốt lõi
                trong cấu trúc xã hội hiện đại...
              </p>
